...
class InternalTransactionDataTable extends BaseDataTable
{
    ...
    {
        return 'mouvements_de_compte_internes_admin';
    }
    ...
    public function columns(): array
    {
        return [
            ...
            Column::make('Client', 'wallet.user.full_name')
                ->sortable()
                ->searchable(),
            ...
            Column::make('Actions')
                ->label(fn (InternalTransaction $row) => view('partials.admin.transactions.internal-actions', ['transaction' => $row])
                )
                ->html(),
        ];
    }
