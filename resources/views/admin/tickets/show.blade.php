...
<div class="content-header-left col-md-8 col-12 mb-2">
    <div class="row breadcrumbs-top">
        <div class="col-12">
            <h2 class="content-header-title float-left mb-0">Ticket Details: {{ $ticket->ticket_number }}</h2>
...
<div class="row">
            ...
            <div class="card-body">
                <div class="ticket-messages">
                    @foreach($ticket->messages as $message)
                        <div class="message mb-4 p-3 {{ $message->sender_type->value === 'customer' ? 'bg-light-primary' : 'bg-light-secondary' }} rounded">
                            <div class="d-flex justify-content-between align-items-start mb-2">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div>
                                        ...
                                        <small class="text-muted">{{ ucfirst($message->sender_type->value) }}</small>
                                    </div>
                                </div>
    ...
    <div class="col-md-4">
            ...
            <div class="card-body">
                ...
                @if($ticket->getMedia('attachments')->count() > 0)
                    ...
                    <div class="initial-attachments">
                        <h6 class="mb-2">Initial Attachments:</h6>
                        <div class="d-flex flex-wrap gap-2">
        ...
        <div class="card mt-3">
            <div class="card-header">
                <h5 class="card-title mb-0">Ticket Progress</h5>
            </div>
            <div class="card-body">
                ...
                <div class="timeline">
                    <div class="timeline-item completed">
                        ...
                        <span class="ms-2">Ticket Created</span>
                    ...
                    @if($ticket->assignedTo)
                        <div class="timeline-item completed mt-2">
                            ...
                            <span class="ms-2">Assigned to Support</span>
                        </div>
                    @endif
                    ...
                    @if($ticket->isReplied())
                        <div class="timeline-item completed mt-2">
                            ...
                            <span class="ms-2">Under Review</span>
                        </div>
                    @endif
                    ...
                    @if($ticket->isResolved() || $ticket->isClosed())
                        <div class="timeline-item completed mt-2">
                            ...
                            <span class="ms-2">{{ $ticket->isResolved() ? 'Resolved' : 'Closed' }}</span>
                            @if($ticket->closed_at)
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="d-grid gap-2">
                    @livewire('admin.ticket.ticket-actions', ['ticket' => $ticket])
                </div>
            </div>
        </div>
        
        @livewire('admin.ticket.assign-ticket-modal')
