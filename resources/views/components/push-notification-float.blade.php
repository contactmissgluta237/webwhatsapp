...
<div id="push-notification-float" class="push-notification-float position-fixed {{ $position }}"
    ...
    <div class="card shadow-lg border-0" style="max-width: 350px; min-width: 300px;">
        <div class="card-body p-3">
            <div class="d-flex justify-content-between align-items-start mb-2">
                ...
                <button type="button" class="btn btn-sm btn-link text-muted p-0" onclick="closePushFloat()"
            ...
            <div id="push-float-content">
                ...
                <div id="push-float-actions" class="d-flex gap-2">
                    ...
                    <button id="disable-push-btn" class="btn btn-outline-secondary btn-sm flex-fill"
                        onclick="deactivatePushNotifications()" style="display: none;">
                ...
                <div id="push-float-settings" style="display: none;">
                    <div class="text-center mt-2">
                        <a href="{{ auth()->user()->hasRole('admin') ? route('admin.profile.show') : route('customer.profile.show') }}"
