...
final class SettingsManagementTest extends TestCase
{
    ...
    #[Test]
    public function admin_can_access_settings_index(): void
    {
    ...
    #[Test]
    public function customer_cannot_access_admin_settings(): void
    {
    ...
    #[Test]
    public function guest_cannot_access_admin_settings(): void
    {
