            ...
            <ul class="nav nav-tabs nav-top-border no-hover-bg" id="configTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" 
                        ...
                        <i class="la la-box"></i>
                        {{ __('Produits') }}
                        @if($account->userProducts()->count() > 0)
                            <span class="badge badge-primary ml-1">{{ $account->userProducts()->count() }}</span>
                        @endif
                    </button>
                </li>
            </ul>
        ...
        <div class="card-body">
            <div class="tab-content" id="configTabsContent">
                ...
                <div class="tab-pane fade show active" 
                    ...
                    @include('livewire.customer.whats-app.tabs.basic-information')
                </div>
                ...
                <div class="tab-pane fade" 
                    ...
                    @include('livewire.customer.whats-app.tabs.contexts')
                </div>
                ...
                <div class="tab-pane fade" 
                    ...
                    @include('livewire.customer.whats-app.tabs.advanced-settings')
                </div>
                ...
                <div class="tab-pane fade" 
                    ...
                    @include('livewire.customer.whats-app.tabs.products')
                </div>
