        ...
        @if($amount)
            <div class="mb-4">
                <h6 class="fw-bold mb-3">
                    ...
                    <span class="ms-2">{{ __('Méthode de paiement') }}</span>
                </h6>
                            ...
                            <div class="form-check p-0">
                                ...
                                <label class="form-check-label w-100" for="method_{{ $method['value'] }}">
                                    <div class="card border-gray-light shadow-none text-center h-100 cursor-pointer payment-option
                                        ...
                                        <div class="card-body p-3">
                                            <i class="ti ti-credit-card fs-1 text-primary mb-2"></i>
            ...
            <div class="mb-4 p-3 border-gray-light shadow-none rounded">
                <div class="row text-center">
                    ...
                    <div class="col-4">
                        ...
                        <div class="fs-4 fw-bold text-success">{{ number_format($totalToPay, 0, ',', ' ') }}</div>
                        <small class="text-muted">{{ $this->getUserCurrency() }}</small>
                    </div>
                </div>
        ...
        @if($payment_method)
            <div class="mb-4">
                <h6 class="fw-bold mb-3">
                    ...
                    <span class="ms-2">{{ __('Détails de paiement') }}</span>
                </h6>
                    ...
                    <div class="card-body">
                        @if(in_array($payment_method, [\App\Enums\PaymentMethod::MOBILE_MONEY()->value, \App\Enums\PaymentMethod::ORANGE_MONEY()->value]))
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <h6 class="mb-0">{{ __('Paiement Mobile Money') }}</h6>
                                    <small class="text-muted">{{ __('Saisissez le numéro depuis lequel sera effectué le retrait') }}</small>
                                </div>
                            </div>
                        ...
                        @elseif($payment_method === \App\Enums\PaymentMethod::BANK_CARD()->value)
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    <h6 class="mb-0">{{ __('Paiement par Carte') }}</h6>
