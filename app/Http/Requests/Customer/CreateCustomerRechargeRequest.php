...
class CreateCustomerRechargeRequest extends FormRequest
{
    ...
    {
        return $this->user()->hasRole(UserRole::CUSTOMER()->value);
    }
    ...
    public function rules(): array
    {
        $rules = [
            ...
            'sender_account' => [
                'required',
                'string',
                'max:'.ValidationLimits::GENERAL_TEXT_MAX_LENGTH,
            ],
        ];
    ...
    public function messages(): array
    {
        $messages = [
            ...
            'amount.max' => 'Le montant maximum est de '.number_format(FinancialLimits::RECHARGE_MAX_AMOUNT, 0, ',', ' ').' FCFA.',
            ...
            'sender_account.max' => 'Les informations de paiement ne peuvent pas dépasser '.ValidationLimits::GENERAL_TEXT_MAX_LENGTH.' caractères.',
        ];
