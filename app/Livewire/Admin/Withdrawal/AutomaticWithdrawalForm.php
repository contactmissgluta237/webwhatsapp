...
class AutomaticWithdrawalForm extends Component
{
    public $customer_id = '';
    public $amount = '';
    ...
    {
        $request = new AutomaticWithdrawalRequest;
    ...
    {
        $this->reset(['customer_id', 'amount', 'payment_method']);
        $this->resetPaymentData();
    ...
    {
        return view('livewire.admin.withdrawal.automatic-withdrawal-form', [
